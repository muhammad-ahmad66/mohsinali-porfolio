...
export const services = [
  {
    ...
    icon: Cpu,
    title: 'AI Engineering, Automation & AI Agents',
    shortDescription:
      'AI-driven systems and intelligent agents that automate operations, execute workflows, and scale decision-making.',
    description:
    ...
    deliverables: [
      ...
      'NLP & LLM-powered models',
      'Predictive & decision systems',
      'AI dashboards & automated reporting',
    ],
