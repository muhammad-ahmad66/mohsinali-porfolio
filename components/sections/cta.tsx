        ...
        <div className="relative overflow-hidden rounded-3xl p-8 shadow-2xl lg:p-16">
          ...
          <div className="absolute inset-0">
            <Image
              ...
              sizes="(max-width: 768px) 100vw, (max-width: 1200px) 100vw, 100vw"
            />
            {/* Adaptive Overlay - darker in light mode, lighter in dark mode */}
          ...
          <div className="relative z-10 mx-auto max-w-3xl text-center text-white">
            ...
            <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
              {/* Primary Button - Solid with green background */}
              <Button
                size="lg"
                className="border-2 border-[#e5ff22] bg-[#e5ff22] text-[#082d25] shadow-md shadow-[#e5ff22]/30 hover:border-[#d4ee11] hover:bg-[#d4ee11] hover:shadow-lg hover:shadow-[#e5ff22]/40 dark:border-[#e5ff22] dark:bg-[#e5ff22] dark:text-[#082d25] dark:hover:border-[#d4ee11] dark:hover:bg-[#d4ee11]"
                asChild
              >
                <Link href={ctaData.buttons.primary.href}>
                  {ctaData.buttons.primary.text}
              ...
              <Button
                ...
                icon={ArrowRight}
                iconPosition="right"
                className="border-2 border-white bg-transparent text-white shadow-md hover:border-white hover:bg-white hover:text-[#082d25] dark:border-white dark:text-white dark:hover:bg-white dark:hover:text-[#082d25]"
                asChild
              >
                <a
                  href={ctaData.buttons.secondary.href}
