...
END:VCARD`;
  ...
  return (
    <div
      className={`dark:via-gray-850 relative overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl dark:border-gray-700 dark:bg-gradient-to-br dark:from-primary-950 dark:to-primary-900 ${className}`}
    >
      ...
      <div className="px-6 pb-6">
        ...
        <div className="mb-6 text-center">
          <h2 className="mb-3 text-2xl font-bold leading-tight text-gray-900 dark:text-gray-50">
            {contactInfo.name}
          </h2>
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#082d25] to-[#0a3d32] px-6 py-4 font-medium text-white shadow-lg transition-all hover:-translate-y-0.5 hover:shadow-xl hover:shadow-[#082d25]/30 dark:from-[#0a3d32] dark:to-[#082d25] dark:shadow-[#e5ff22]/10 dark:hover:shadow-[#e5ff22]/20"
        >
